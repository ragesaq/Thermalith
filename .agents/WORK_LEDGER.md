...
- 2026-08-13 — Printer identified: NIIMBOT B1 Pro (id 4097, 300 dpi, 567 px, B1 series, catalogue-unverified); wireless channel confirmed as BLE by desk research (SiFli SF32 BLE MCU, niimblue drives it via Web Bluetooth) [ragesaq-002] (commit c4617cd)
