...
- 2026-08-13 — BLE stack decided (D-005 accepted): per-OS transports, macOS first via pure-C# CoreBluetooth ObjC interop; package-verified that no cross-platform .NET BLE lib supports plain-TFM mac apps [ragesaq-003] (commit b3b7bba)
